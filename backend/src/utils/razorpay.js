 ...
 */
export const createRazorpayOrder = async ({ amount, currency = 'INR', receipt, payment_capture = 1 }) => {
  const options = {
    amount,
    currency,
    receipt,
 ...
 * @returns {boolean}
 */
export const verifyPaymentSignature = ({ order_id, payment_id, razorpay_signature }) => {
